...
ldm_ae.save_to_file("ldm_autoencoder_rgb.pt")
print("LDM Autoencoder saved to ldm_autoencoder_rgb.pt")
...
torch.save(denoiser_latent.state_dict(), "latent_diffusion_model_rgb.pt")
...
plt.legend()
plt.tight_layout()
plt.savefig("roc_curve_ldm_vlb_rgb.png", dpi=150)
plt.show()
print("Saved ROC curve to roc_curve_ldm_vlb_rgb.png")

np.save("ldm_test_scores.npy", scores_vlb) # save scores for calibration

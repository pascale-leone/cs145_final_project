...
from latent_diffusion import LinearNoiseScheduler, NoisePredictor
...
torch.save(denoiser_latent.state_dict(), "ldm_denoiser.pt")
...
torch.save(denoiser_direct.state_dict(), "direct_diffusion_denoiser.pt")
...
plt.show()
print("Saved ROC plot to roc_curve_comparison.png")

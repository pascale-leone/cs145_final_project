...
X_train_vids = np.stack([features[k] for k in train_keys])   # (N_train, 32, 1024)
X_test_vids  = np.stack([features[k] for k in test_keys])    # (N_test,  32, 1024)
...
print(f"\nBest sigma2 {best_sigma2}, AUC-ROC: {auc:.4f}")
